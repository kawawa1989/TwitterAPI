...
public class TwitterTestController : MonoBehaviour
{
    ...
    public void Login()
    {
        ...
        var req = new OAuthRequest(url, OAuthRequestMethod.GET, m_oauthClient, null, new OAuthSignature_HMACSHA1());
    ...
    public void OnEnterPIN()
    {
        ...
        var req = new OAuthRequest(url, OAuthRequestMethod.POST, m_oauthClient, m_token, new OAuthSignature_HMACSHA1(), body);
        req.SendWebRequest((result) =>
        {
